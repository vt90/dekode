...
class Parser {
    ...
    static decodeTxOutScript(script) {
...
//             username: '__cookie__',
//             password: 'b95568c225fc0d4c57634b78f91efa9e8795b51c123cb78dfc6129901aa20bb7',
//             version: '0.17.1'
//         });
//         // const blockCount = await client.getBlockCount();
//         const blockCount = 500000;
//         for (let i = 450000; i < blockCount; ++i) {
//             const blockHash = await client.getBlockHash(i);
//             const rawBlockData = await client.getBlock(blockHash, 0);
//             const parsedBlock = new Parser(Buffer.alloc(rawBlockData.length, rawBlockData, 'hex'));
//             const buffSize = parsedBlock.buff.slice(0, parsedBlock.buff.length).toString('hex').length;
//             if (buffSize !== 4 * parsedBlock.currentPosition) {
//                 throw new Error(`error at parsing block , ${i} , ${blockHash} `);
//             }
//             delete parsedBlock.buff;
//             delete parsedBlock.currentPosition;
//             console.log(parsedBlock);
//             fs.writeFile(`parsedBlocks/${blockHash}`, JSON.stringify(parsedBlock));
//         }
...
// delete parser.buff;
// console.log(parser.transactions[0]);
// console.log(parser.transactions.forEach(tx=> {
//     if(tx.txFlag) console.log(JSON.stringify(tx));
// }));
